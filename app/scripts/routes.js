 ...
 */
  ...
  .config(['$routeProvider', function($routeProvider) {
    $routeProvider
      ...
      .whenAuthenticated('/world/new', {
        templateUrl: 'views/world/new.html',
        controller: 'WorldNewCtrl'
      })
      .when('/world/:id', {
        templateUrl: 'views/world/view.html',
        controller: 'WorldViewCtrl',
        resolve: {
          world: function($route, WorldService) {
              var params = $route.current.params;
              return WorldService.findByKey(params.id);
          }
        }
      })
      .whenAuthenticated('/world/:id/edit', {
        templateUrl: 'views/world/edit.html',
